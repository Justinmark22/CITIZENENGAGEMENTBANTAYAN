...
class MadridejosAnnouncementController extends Controller
{
...
{
    $announcement = Announcement::findOrFail($id);
    return view('madridejos.announcement_edit', compact('announcement'));
}
...
$announcement->update([
    ...
    return redirect()->route('madridejos.announcements') // ✅ Correct route name here
