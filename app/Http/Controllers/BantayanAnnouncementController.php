...
class BantayanAnnouncementController extends Controller
{
...
{
    $announcement = Announcement::findOrFail($id);
    return view('bantayan.announcement_edit', compact('announcement'));
}
...
$announcement->update([
    ...
    return redirect()->route('bantayan.announcements') // ✅ Correct route name here
