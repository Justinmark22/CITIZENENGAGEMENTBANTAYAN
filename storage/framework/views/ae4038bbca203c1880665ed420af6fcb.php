      ...
      <div class="space-y-4">
        <form action="<?php echo e(route('feedback.submit')); ?>" method="POST">
          ...
          <div>
            ...
            <input type="text" id="location" name="location" value="<?php echo e(Auth::user()->location ?? 'No Location'); ?>" readonly
...
<?php /**PATH C:\Users\ADMIN\my-app\CITIZENENGAGEMENTBANTAYAN\resources\views/feedback.blade.php ENDPATH**/ ?>