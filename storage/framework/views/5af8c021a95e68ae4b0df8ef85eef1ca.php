  ...
  <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-4xl overflow-hidden">
    <div class="grid md:grid-cols-2">
      ...
      <div class="p-10 space-y-6">
        ...
        <form method="POST" action="<?php echo e(route('register.submit')); ?>" class="space-y-4">
          ...
          <p class="text-center text-sm mt-4 text-gray-400">
            ...
            <a href="<?php echo e(route('login')); ?>" class="text-indigo-400 hover:text-indigo-300">Login here</a>
          </p>
        </form>
      </div>
      ...
      <div class="hidden md:flex flex-col items-center justify-center bg-gray-900 p-8 text-center">
        <img src="<?php echo e(asset('images/citizen.png')); ?>" alt="Logo" class="w-32 h-32 rounded-full mb-4 border border-gray-700 shadow-lg">
...
<?php /**PATH C:\Users\ADMIN\my-app\CITIZENENGAGEMENTBANTAYAN\resources\views/register.blade.php ENDPATH**/ ?>