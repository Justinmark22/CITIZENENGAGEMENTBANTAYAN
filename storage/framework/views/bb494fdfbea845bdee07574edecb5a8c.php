  ...
  <aside 
    ...
    <nav class="flex flex-col gap-4 text-sm md:text-base">
      <div>
        ...
        <a href="<?php echo e(route('dashboard.mdrrmo-bantayan')); ?>" class="flex items-center gap-3 px-4 py-2 rounded-lg bg-blue-300 hover:bg-blue-200 transition-all font-medium">
...
<?php /**PATH C:\Users\ADMIN\my-app\CITIZENENGAGEMENTBANTAYAN\resources\views/mdrrmo/mdrrmo_bantayan-announcements.blade.php ENDPATH**/ ?>