...
<div class="relative w-full md:w-auto">
  <button onclick="toggleDropdown('alertsDropdown'); clearBadge();" 
    ...
    <?php if($totalAlerts > 0): ?>
      <span id="alertsBadge" class="absolute -top-1 -right-1 bg-red-600 text-white text-xs font-semibold px-1.5 py-0.5 rounded-full shadow"><?php echo e($totalAlerts); ?></span>
    <?php endif; ?>
  </button>
  ...
  <div id="alertsDropdown" class="hidden absolute right-0 mt-2 w-80 md:w-96 bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden z-50">
        ...
        <?php $__currentLoopData = $groupData['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reports): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div onclick="openReportModal(<?php echo e($report->id); ?>, '<?php echo e($report->title); ?>', '<?php echo e($report->status); ?>', '<?php echo e($report->forwarded_to); ?>')" 
              ...
              <div class="flex-1">
                <p class="text-<?php echo e($groupData['color']); ?>-700 text-sm font-medium">
                  <?php echo e($report->status); ?> <?php echo e(strpos($group,'Waste') !== false ? '♻' : ''); ?>
    ...
    <div class="relative w-full md:w-auto">
      <button onclick="toggleDropdown('userDropdown')" class="flex items-center justify-between md:justify-start w-full md:w-auto gap-2 text-gray-700 hover:text-green-700 transition">
        ...
        <span class="md:inline hidden font-medium"><?php echo e(Auth::user()->name ?? 'Guest'); ?></span>
      ...
      <div id="userDropdown" class="hidden absolute right-0 mt-2 bg-white shadow-xl rounded-xl w-64 overflow-hidden border border-gray-100 z-50">
        <div class="px-5 py-4 bg-gray-50">
          <p class="font-semibold"><?php echo e(Auth::user()->name ?? 'Guest'); ?></p>
          <p class="text-gray-500 text-sm"><?php echo e(Auth::user()->email ?? 'No Email'); ?></p>
          <p class="text-gray-400 text-sm"><?php echo e(Auth::user()->location ?? 'No Location'); ?></p>
        </div>
        <div class="border-t">
      ...
      <div class="bg-white rounded-3xl shadow-xl p-6 h-full flex flex-col">
        ...
        <div class="overflow-auto space-y-5 flex-1" style="max-height: 480px;">
          ...
          <?php $__empty_1 = true; $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php $isNew = Carbon::parse($report->updated_at)->gt(now()->subDay()); ?>
              ...
              <div class="flex justify-between items-start gap-3">
                <div class="flex flex-col gap-2">
                  ...
                  <p class="text-gray-700 text-sm">
                    ...
                    <span class="font-semibold text-success"><?php echo e($report->category); ?></span> 
                    has been successfully resolved by <strong>MDRRMO</strong>.
                  </p>
                  <div class="text-xs text-gray-500 mt-2 space-y-1 flex flex-col">
                    <div class="flex items-center gap-1"><i class="bi bi-calendar-event-fill text-green-600"></i> Submitted: <?php echo e($report->created_at->format('M d, Y h:i A')); ?></div>
                    <div class="flex items-center gap-1"><i class="bi bi-check2-circle text-success"></i> Resolved: <?php echo e($report->updated_at->format('M d, Y h:i A')); ?></div>
                    <div class="flex items-center gap-1">
                      <i class="bi bi-hash text-gray-400"></i> Report ID: <span class="font-mono"><?php echo e($report->id); ?></span>
                      <button onclick="navigator.clipboard.writeText('<?php echo e($report->id); ?>')" class="ml-2 text-xs text-success hover:text-success/70" title="Copy ID">
                ...
                <div class="flex flex-col items-end gap-2">
                  ...
                  <span class="px-3 py-1 rounded-full text-xs font-semibold bg-success/30 text-success flex items-center gap-1">
                    <i class="bi bi-tag-fill"></i> <?php echo e($report->category); ?>
            ...
            <div class="relative group bg-gradient-to-r from-yellow-50 to-yellow-100 border-l-4 border-yellow-500 rounded-2xl p-5 shadow-md hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-500 overflow-hidden animate-fadeIn">
              ...
              <div class="flex justify-between items-start gap-3">
                <div class="flex flex-col gap-2">
                  ...
                  <div class="text-xs text-gray-500 mt-2 space-y-1 flex flex-col">
                    <div class="flex items-center gap-1"><i class="bi bi-calendar-event-fill text-yellow-600"></i> Submitted: <?php echo e($report->created_at->format('M d, Y h:i A')); ?></div>
                    <div class="flex items-center gap-1"><i class="bi bi-check2-circle text-yellow-500"></i> Resolved: <?php echo e($report->updated_at->format('M d, Y h:i A')); ?></div>
                    <div class="flex items-center gap-1">
                      <i class="bi bi-hash text-gray-400"></i> Report ID: <span class="font-mono"><?php echo e($report->id); ?></span>
...
<div id="reportModal" class="hidden fixed inset-0 bg-black/50 z-50 items-center justify-center p-4">
  <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg p-6 animate-fadeIn">
    ...
    <form id="reportForm" method="POST" action="<?php echo e(route('reports.store')); ?>" enctype="multipart/form-data" class="space-y-4">
      <?php echo csrf_field(); ?>
      <div>
...
<?php /**PATH C:\Users\ADMIN\my-app\CITIZENENGAGEMENTBANTAYAN\resources\views/dashboard/madridejos.blade.php ENDPATH**/ ?>