...
<head>
  <meta charset="UTF-8">
  <title>Madridejos Feedback</title>
...
<a href="{{ route('madridejos.updates.index') }}">
  ...
  <div class="navbar d-flex justify-content-between align-items-center">
    <div class="d-flex align-items-center">
      ...
      <h5 class="mb-0">Municipality of Madridejos - Feedback</h5>
    </div>
    <div class="d-flex align-items-center">
...
<div class="main">
  ...
  <footer class="mt-5">
    &copy; {{ date('Y') }} Municipality of Madridejos. All rights reserved.
  </footer>
</div>
    ...
    <div class="modal-content shadow-lg border-0 rounded-4">
      ...
      <div class="modal-body px-4 py-4" id="feedbackModalBody">
        ...
        <div class="text-center mb-4 animate__animated animate__fadeInUp">
          ...
          <h4 class="fw-bold mt-2 text-primary">Municipality of Madridejos</h4>
