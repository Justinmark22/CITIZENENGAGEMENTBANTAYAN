...
<head>
  <meta charset="UTF-8">
  <title>Post Update | Madridejos</title>
...
<div class="container">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('madridejos.updates.index') }}" class="btn btn-outline-secondary rounded-pill d-flex align-items-center">
      <i data-lucide="arrow-left" class="me-1"></i> Back
    </a>
  </div>

  <form action="{{ route('madridejos.updates.store') }}" method="POST" class="custom-card animate__animated animate__fadeIn">
    @csrf
    ...
    <div class="mb-4">
      ...
      <input type="text" class="form-control rounded-pill shadow-sm" name="location" value="Madridejos" readonly>
    </div>
