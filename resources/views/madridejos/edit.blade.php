...
<head>
  <meta charset="UTF-8">
  <title>Edit Madridejos User</title>
...
<body>
  ...
  <div class="container-box">
    ...
    <form method="POST" action="{{ route('madridejos.users.update', $user->id) }}">
      @csrf
      @method('PUT')
      ...
      <div class="d-flex justify-content-between">
        <a href="{{ route('madridejos.users.index') }}" class="btn btn-secondary">
