...
<head>
  <meta charset="UTF-8">
  <title>Santa Fe Admin Announcements</title>
...
<div class="main">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('santafe.announcements.create') }}" class="btn btn-primary">
      <i data-lucide="plus" class="me-1"></i> Add Announcement
    </a>
  </div>

  <!-- Search and Filters -->
  <form method="GET" action="{{ route('santafe.announcements') }}" class="row g-3 mb-4">
    <div class="col-md-4">
    ...
    <div class="card-body">
      ...
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2">
          <a href="{{ route('santafe.announcements.edit', $announcement->id) }}" class="btn btn-sm btn-outline-secondary">
            <i data-lucide="edit" class="me-1"></i> Edit
          </a>

          <form action="{{ route('santafe.announcements.destroy', $announcement->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this announcement?');">
            @csrf
            @method('DELETE')
          ...
          <div class="w-100" style="max-width: 750px;">
            ...
            <div class="mb-4">
              ...
              <select name="barangay" id="barangay{{ $announcement->id }}" class="form-select form-select-lg text-center" required>
                ...
                <option value="Kandaya">Kandaya</option>
              </select>
            </div>
