...
<head>
  ...
  <style>
    ...
    .sidebar {
      ...
      position: fixed;
      height: 100vh;
      background: linear-gradient(180deg, #80e9b4, #1d4ed8);
      padding: 2rem 1rem;
      color: white;
    }
    .sidebar a {
...
<div class="sidebar">
  ...
  <a href="{{ route('dashboard.santafeadmin') }}"><i data-lucide="home"></i> Dashboard</a>
  <a href="{{ route('santafe.users.index') }}"><i data-lucide="users"></i> Users</a>
  <a href="{{ route('santafe.reports') }}"><i data-lucide="file-text"></i> Reports</a>
  <a href="{{ route('santafe.feedback') }}"><i data-lucide="message-square"></i> Feedback</a>
  <a href="{{ route('santafe.announcements') }}"><i data-lucide="megaphone"></i> Announcements</a>
  <a href="{{ route('santa_fe.events') }}"><i data-lucide="calendar-days"></i> Events</a>
  <a href="#"><i data-lucide="message-square"></i> Updates</a>
</div>
...
<div class="main">
  <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
    ...
    <a href="{{ route('santafe.updates.create') }}" class="btn btn-success rounded-pill shadow-sm d-flex align-items-center">
  ...
  <div class="card-box animate__animated animate__fadeInUp mb-4 border-start border-4 border-primary">
    ...
    <div class="d-flex justify-content-between align-items-center mt-3">
      ...
      <div class="d-flex gap-2">
        ...
        <!-- Delete Form -->
        <form action="{{ route('santafe.updates.destroy', $update->id) }}" method="POST"
  ...
  <div class="modal fade" id="editModal{{ $update->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $update->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content rounded-4 shadow">
        ...
        <form action="{{ route('santafe.updates.update', $update->id) }}" method="POST">
          @csrf
          @method('PUT')
