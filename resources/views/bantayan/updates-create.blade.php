...
<head>
  <meta charset="UTF-8">
  <title>Post Update | Bantayan</title>
...
<div class="container">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('bantayan.updates.index') }}" class="btn btn-outline-secondary rounded-pill d-flex align-items-center">
      <i data-lucide="arrow-left" class="me-1"></i> Back
    </a>
  </div>

  <form action="{{ route('bantayan.updates.store') }}" method="POST" class="custom-card animate__animated animate__fadeIn">
    @csrf
    ...
    <div class="mb-4">
      ...
      <input type="text" class="form-control rounded-pill shadow-sm" name="location" value="Bantayan" readonly>
    </div>
