...
<div class="main">
  <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
    ...
    <a href="{{ route('bantayan.updates.create') }}" class="btn btn-success rounded-pill shadow-sm d-flex align-items-center">
  ...
  <div class="card-box animate__animated animate__fadeInUp mb-4 border-start border-4 border-primary">
    ...
    <div class="d-flex justify-content-between align-items-center mt-3">
      ...
      <div class="d-flex gap-2">
        ...
        <!-- Delete Form -->
        <form action="{{ route('bantayan.updates.destroy', $update->id) }}" method="POST"
  ...
  <div class="modal fade" id="editModal{{ $update->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $update->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content rounded-4 shadow">
        ...
        <form action="{{ route('bantayan.updates.update', $update->id) }}" method="POST">
          @csrf
          @method('PUT')
