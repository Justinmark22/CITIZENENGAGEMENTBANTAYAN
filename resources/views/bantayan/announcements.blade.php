...
<head>
  <meta charset="UTF-8">
  <title>Bantayan Announcements</title>
    ...
    <div class="card-body">
      ...
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2">
          <a href="{{ route('bantayan.announcements.edit', $announcement->id) }}" class="btn btn-sm btn-outline-secondary">
            <i data-lucide="edit" class="me-1"></i> Edit
          </a>

          <form action="{{ route('bantayan.announcements.destroy', $announcement->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this announcement?');">
            @csrf
            @method('DELETE')
