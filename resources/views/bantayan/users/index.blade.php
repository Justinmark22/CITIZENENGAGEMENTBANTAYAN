...
<head>
  <meta charset="UTF-8">
  <title>Manage Bantayan Users</title>
...
<!-- Logo Section -->
 <div class="text-center mb-4">
  ...
  <div class="navbar d-flex justify-content-between align-items-center">
    <h5 class="mb-0">Manage Bantayan Users</h5>
    <div class="dropdown">
      ...
      @forelse ($users as $user)
        @if ($user->email !== 'admin@santafe.com')
          <tr class="user-row">
            ...
            <td class="text-end">
              <a href="{{ route('bantayan.users.edit', $user->id) }}"
              ...
              <form action="{{ route('bantayan.users.destroy', $user->id) }}"
