...
<head>
  ...
  <title>MDRRMO Santa Fe – Resolved Reports</title>
...
<aside 
  ...
  <nav class="flex flex-col gap-4">
    ...
    <div>
      ...
      <a href="{{ route('dashboard.mdrrmo-santafe') }}" class="flex items-center gap-3 px-4 py-2 rounded-lg bg-blue-300 hover:bg-blue-200 transition-all">
