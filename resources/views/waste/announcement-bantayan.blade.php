...
<head>
  ...
  <title>Waste Bantayan – Resolved Reports</title>
...
<body class="bg-gray-100 font-sans flex min-h-screen" x-data="reportApp()" x-init="fetchReports()">
  ...
  <aside class="fixed md:static inset-y-0 left-0 z-40 w-64 
    ...
    <div class="flex items-center justify-between mb-10">
      ...
      <span class="text-2xl font-extrabold tracking-wide drop-shadow-sm">Waste Bantayan</span>
    ...
    <nav class="flex flex-col gap-4">
      <div>
        ...
        <a href="{{ route('dashboard.waste-bantayan') }}" 
      ...
      <div>
        ...
        <a href="{{ route('waste.reports-bantayan') }}" 
      ...
      <div>
        ...
        <a href="{{ route('waste.announcement-bantayan') }}" 
           class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-blue-200 transition-all">
