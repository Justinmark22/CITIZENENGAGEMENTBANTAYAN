    ...
    <aside class="w-64 bg-gradient-to-b from-sky-600/90 to-sky-800/90 text-white flex flex-col shadow-xl backdrop-blur-md border-r border-white/10">
        ...
        <div class="flex items-center space-x-3 px-6 py-5 border-b border-white/20">
            ...
            <div>
                ...
                <p class="text-blue-100 text-sm tracking-wide">Bantayan</p>
            </div>
        </div>
        ...
        <nav class="mt-6 flex-1 px-3 space-y-8">
            ...
            <div>
                ...
                <a href="{{ route('water.reports-bantayan') }}" class="flex items-center px-4 py-3 rounded-lg text-sky-50 hover:bg-white/10 hover:shadow-sm transition">
                    <svg class="h-5 w-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
                <h3 class="text-xs uppercase tracking-widest text-white/60 font-semibold px-3 mb-3">Announce</h3>
