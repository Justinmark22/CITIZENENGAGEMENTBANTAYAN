...
<head>
  ...
  <title>Madridejos Fire Management Dashboard</title>
...
<div class="flex min-h-screen">
  ...
  <main class="flex-1 bg-gradient-to-br from-gray-50 to-gray-100 p-10 overflow-y-auto">
    <!-- Header -->
    <header class="sticky top-0 z-10 mb-8 backdrop-blur-lg bg-white/90 border border-gray-200 shadow-md rounded-2xl px-6 py-4 flex justify-between items-center">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">Madridejos Fire Dashboard</h1>
        <p class="text-gray-500 mt-1">Welcome, Fire Administrator</p>
      </div>
    </header>
    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-10">
      @php
        $cards = [
          ['title' => 'Total Reports', 'count' => $totalReports, 'color' => 'red'],
      ...
      <div class="bg-white shadow-lg rounded-2xl p-6 border-t-4 border-{{ $card['color'] }}-600 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-200">
        ...
        <div class="flex justify-between items-center mt-4">
          ...
          <div class="bg-{{ $card['color'] }}-100 text-{{ $card['color'] }}-700 p-3 rounded-lg shadow-inner">
      ...
      <div class="overflow-x-auto rounded-lg border border-gray-100 shadow-inner">
        <table class="min-w-full divide-y divide-gray-200 text-sm">
          <thead class="bg-red-100 sticky top-0 z-10">
            <tr>
              <th class="px-6 py-3 text-left font-semibold text-red-700 uppercase tracking-wider">Category</th>
              <th class="px-6 py-3 text-left font-semibold text-red-700 uppercase tracking-wider">Description</th>
              <th class="px-6 py-3 text-left font-semibold text-red-700 uppercase tracking-wider">Status</th>
              <th class="px-6 py-3 text-left font-semibold text-red-700 uppercase tracking-wider">Date</th>
            </tr>
          </thead>
