...
<head>
  ...
  <title>Santa Fe LGU Dashboard</title>
...
<body>
  ...
  <div class="mb-4">
    <h2>Welcome, Admin</h2>
    <p class="text-muted">Municipality of Santa Fe - LGU Monitoring and Feedback Dashboard</p>
  </div>
  ...
  <div class="card-box">
    ...
    <p>Total reports in Santa Fe: <strong>{{ $totalReports }}</strong></p>
    <p>Pending reports in Santa Fe: <strong>{{ $pendingReports }}</strong></p>
  </div>
