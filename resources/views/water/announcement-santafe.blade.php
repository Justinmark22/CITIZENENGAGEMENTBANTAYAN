...
<aside 
  ...
  <nav class="flex flex-col gap-4">
    ...
    <div>
      ...
      <a href="{{ route('dashboard.water-santafe') }}" class="flex items-center gap-3 px-4 py-2 rounded-lg bg-blue-300 hover:bg-blue-200 transition-all">
    ...
    <div>
      ...
      <a href="{{ route('water.reports-santafe') }}" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-blue-200 transition-all">
    ...
    <div>
      ...
      <a href="{{ route('water.announcement-santafe') }}" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-blue-200 transition-all">
